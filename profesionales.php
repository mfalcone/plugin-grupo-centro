...
function profesionales_init() {
    ...
    wp_register_script("my_react_app_js", plugins_url($path."/js/main.js?2454", __FILE__), array(), "1.0", false);
    wp_register_style("my_react_app_css", plugins_url($path."/css/main.css?2454", __FILE__), array(), "1.0", "all");
}
